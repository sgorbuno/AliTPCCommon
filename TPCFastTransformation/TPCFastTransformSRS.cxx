...
/// \file  TPCFastTransformSRS.cxx
/// \brief Implementation of TPCFastTransformSRS class
///
/// \author  Sergey Gorbunov <sergey.gorbunov@cern.ch>
/// modified by Felix Lapp 25.09.2018
...
namespace ali_tpc_common {
  namespace tpc_fast_transformation {
    ...
    TPCFastTransformSRS::TPCFastTransformSRS()
      :
      FlatObject(),
    ...
    void TPCFastTransformSRS::relocateBufferPointers( const char* oldBuffer, char *actualBuffer )
    {
    ...
    void TPCFastTransformSRS::cloneFromObject( const TPCFastTransformSRS &obj, char *newFlatBufferPtr )
    {
    ...
    void TPCFastTransformSRS::moveBufferTo( char *newFlatBufferPtr )
    {
      /// See FlatObject for description   
    ...
    void TPCFastTransformSRS::setActualBufferAddress( char* actualFlatBufferPtr )
    {
      /// See FlatObject for description
      const char *oldFlatBufferPtr = mFlatBufferPtr;
    ...
    void TPCFastTransformSRS::setFutureBufferAddress( char* futureFlatBufferPtr )
    {
      /// See FlatObject for description
    ...
    void TPCFastTransformSRS::startConstruction( int numberOfRows )
    {
    ...
    void TPCFastTransformSRS::setTPCgeometry( float tpcZlengthSideA, float tpcZlengthSideC )
    {
      /// Sets TPC geometry
      ///
    ...
    void TPCFastTransformSRS::setCalibration( long int timeStamp, float t0, float vDrift, float vDriftCorrY, 
    ...
    void TPCFastTransformSRS::finishConstruction()
    {
      ...
      size_t bufferSize = distortionOffset + mDistortion.getFlatBufferSize();
