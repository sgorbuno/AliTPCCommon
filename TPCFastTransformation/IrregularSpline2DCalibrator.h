...
#ifndef IrregularSpline2DCalibrator_H
#define IrregularSpline2DCalibrator_H
...
class IrregularSpline2DCalibrator 
{
 public:
  ...
  IrregularSpline2DCalibrator();

  /// Destructor
  ~IrregularSpline2DCalibrator() CON_DEFAULT;
